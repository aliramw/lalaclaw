...
function ThemeToggle({ onChange, value }) {
  const options = [
  ...
  return (
    <div className="inline-flex items-center rounded-full border border-border/70 bg-background/90 p-1">
      {options.map((option) => {
        ...
        return (
          <button
            ...
            className={cn(
              ...
              active
                ? "border-rose-300 bg-rose-50 text-rose-500 dark:border-sky-400/40 dark:bg-sky-400/10 dark:text-sky-300"
              ...
              <div className="flex min-w-max items-center gap-2">
                ...
                <div className="inline-flex h-14 items-center gap-3 rounded-lg border border-border/70 bg-background/80 px-3 py-2">
                  <div className="min-w-0">
                    ...
                    <div className={cn("text-sm font-semibold", fastMode && "text-emerald-700 dark:text-emerald-400")}>{fastMode ? "已开启" : "已关闭"}</div>
                  </div>
