...
function isEligibleForReroute(position, now, cooldownMs, reroutedWalkerIds) {
...
export function findNearbyCollisionPairs(positions = [], {
...
export function chooseCollisionRerouteTarget(current, other, {
  now = 0,
  cooldownMs = 0,
