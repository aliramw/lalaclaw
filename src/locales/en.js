const en = {
  ...
  sessionOverview: {
    ...
    sessionSearch: {
      ...
      placeholder: "For example: group name, user id, keyword",
      search: "Search",
      searching: "Searching…",
      close: "Close",
      emptyPrompt: "Enter a keyword to search, or press Search to inspect recent DingTalk sessions.",
      empty: (term) => `No DingTalk session matched “${term}”.`,
      sessionUserLabel: "Session",
      updatedLabel: "Last updated",
      previewLabel: "Recent content",
      useResult: "Switch to this session",
      switching: "Switching…",
