...
exports.createChatStopHandler = createChatStopHandler;
    ...
    return async function handleChat(req, res) {
        ...
        try {
            ...
            if (!usesGatewayNativeCommands && fastCommand) {
                ...
                const outputText = fastCommand.action === 'status'
            ...
            if (!usesGatewayNativeCommands && modelCommand) {
                ...
                const outputText = modelCommand.action === 'list'
                ...
                sendJson(res, 200, {
                    ...
                    metadata: {
                        status: snapshot.session.status,
                        summary: modelCommand.action === 'set'
                            ? `model: ${selectedModel}`
