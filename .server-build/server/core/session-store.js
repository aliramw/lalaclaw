...
exports.THINK_MODES = void 0;
exports.normalizeSessionUser = normalizeSessionUser;
exports.normalizeThinkMode = normalizeThinkMode;
exports.extractAgentIdFromNativeSessionKey = extractAgentIdFromNativeSessionKey;
exports.createSessionStore = createSessionStore;
exports.THINK_MODES = ['off', 'minimal', 'low', 'medium', 'high', 'xhigh', 'adaptive'];
function normalizeSessionAttachments(attachments = [], { preserveInlineContent = false } = {}) {
...
function normalizeThinkMode(value = '') {
    ...
    return exports.THINK_MODES.includes(normalized) ? normalized : '';
}
...
function createSessionStore({ getDefaultAgentId, getDefaultModelForAgent, resolveCanonicalModelId }) {
    ...
    function setSessionPreferences(sessionUser = 'command-center', next = {}) {
        ...
        if (!exports.THINK_MODES.includes(String(merged.thinkMode || '').trim().toLowerCase())) {
