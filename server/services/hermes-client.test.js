...
describe("createHermesClient", () => {
  ...
  it("preserves a single progress-like paragraph before a blank separator when it could be the real reply", async () => {
    const client = createHermesClient({
      HERMES_BIN: "hermes",
      PROJECT_ROOT: "/workspace/project",
      execFileAsync: vi.fn(async () => ({
  ...
  it("preserves a single progress-like first line when it is part of the real reply", async () => {
    const client = createHermesClient({
      HERMES_BIN: "hermes",
      PROJECT_ROOT: "/workspace/project",
      execFileAsync: vi.fn(async () => ({
