...
const DEFAULT_ACCESS_COOKIE_NAME = 'lalaclaw_access';
const DEFAULT_ACCESS_SESSION_TTL_MS = 1000 * 60 * 60 * 24 * 30;
...
function loadConfiguredAccessTokens(config = {}, readTextIfExists = () => '') {
  ...
  const fileTokens = config.accessTokensFile
    ? parseAccessTokens(readTextIfExists(config.accessTokensFile))
    : [];
