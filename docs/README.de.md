...
Wenn du eine bestimmte Version installieren willst, zum Beispiel `2026.3.20-2`:
...
- Fuer mehrere Releases am selben Tag nutze `YYYY.M.D-N`, zum Beispiel `2026.3.20-2`
