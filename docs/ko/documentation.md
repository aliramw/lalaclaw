...
이 문서는 현재 저장소의 frontend, backend, test, configuration 을 기준으로 작성되었습니다. 실제 동작을 탐색 가능한 Markdown 페이지로 정리하는 것이 목적입니다.

저자: Marila Wang

## 문서 트리

- [빠른 시작](./documentation-quick-start.md)
- [인터페이스 개요](./documentation-interface.md)
- [채팅, 첨부파일, 명령어](./documentation-chat.md)
- [Inspector, 파일 미리보기, tracing](./documentation-inspector.md)
- [세션, 에이전트, 실행 모드](./documentation-sessions.md)
