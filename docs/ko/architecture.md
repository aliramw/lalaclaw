...
> 탐색: [문서 홈](./documentation.md) | [빠른 시작](./documentation-quick-start.md) | [인터페이스 개요](./documentation-interface.md) | [제품 소개](./showcase.md) | [리팩터링 로드맵](./refactor-roadmap.md)

LalaClaw 는 가벼운 UI 진입점, 가벼운 서버 진입점, 그리고 테스트하기 쉬운 중간 모듈로 구성됩니다.

- src 는 React UI 와 기능 컨트롤러를 포함합니다
- server 는 라우트, 서비스, 런타임 연동을 포함합니다
