...
[Kembali ke utama](./documentation.md) | [Sembang, lampiran dan arahan](./documentation-chat.md) | [Persistensi tempatan dan pemulihan](./documentation-persistence.md)

# Sesi, Ejen dan Mod Pelaksanaan

## Sesi

- Tab disusun mengikut ejen
- Identiti sebenar sesi ialah `agentId + sessionUser`
- Menutup tab hanya menyembunyikan paparan, bukan memadamkan sesi

## Ejen dan model

- Ejen datang daripada konfigurasi runtime yang dibenarkan
- Model dan mod pemikiran dibaca daripada pilihan yang dilaporkan oleh backend
- Mod pantas dan mod pemikiran disegerakkan mengikut sesi

## Mod pelaksanaan

- Aplikasi boleh berjalan dalam mod mock secara lalai
- Dengan gateway aktif, ia akan menggunakan endpoint OpenClaw sebenar
- Status runtime, auth dan baris gilir dipaparkan pada pengepala
