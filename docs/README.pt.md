...
Uma forma melhor de co-criar com OpenClaw.
...
Se quiser uma versao especifica, por exemplo `2026.3.24`:
...
- Para varias releases no mesmo dia, use `YYYY.M.D-N`, por exemplo `2026.3.24`
