...
- [Chat, pièces jointes et commandes](./documentation-chat.md)
...
1. Commencez par [Démarrage rapide](./documentation-quick-start.md) pour lancer le frontend et le backend.
2. Lisez ensuite [Vue d'ensemble de l'interface](./documentation-interface.md) et [Chat, pièces jointes et commandes](./documentation-chat.md) pour comprendre le flux principal.
3. Pour le petit détail de marque, consultez [Easter egg](./documentation-easter-egg.md).
...
- Ouvrir des onglets de session séparés pour différents agents, chacun avec son propre modèle, fast mode et thinking mode.
