...
- `lalaclaw doctor` மற்றும் `npm run doctor` இப்போது நிறமுள்ள status labels, கிடைக்கும் போது macOS `launchd` service தகவல்கள், preview prerequisites, மற்றும் இறுதி summary line ஆகியவற்றைக் காட்டும்; app-ஐ திறக்கும்முன் startup blockers-ஐ கண்டுபிடிக்க இது உதவும்
- `lalaclaw start` மற்றும் `npm run lalaclaw:start` தொடங்கும் முன் அதே doctor preflight-ஐ இயக்கும்; இன்னும் blocking errors இருந்தால் startup உடனே நிறுத்தப்படும்
- macOS இல் doctor output LaunchAgent plist path மற்றும் log directory-யையும் காட்டும்; `lalaclaw init` பிறகான background startup பிரச்சினைகளை debug செய்ய இது உதவும்
